...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.attachToWorktree.title': '워크트리에 연결',
  'sessions.sidebar.attachToWorktree.description': '이 세션에서 볼 워크트리의 git 변경사항과 브랜치를 선택합니다.',
  'sessions.sidebar.attachToWorktree.confirm': '연결',
  'sessions.sidebar.attachToWorktree.detach': '해제',
  'sessions.sidebar.attachToWorktree.noWorktrees': '이 프로젝트에 사용 가능한 워크트리가 없습니다.',
  'sessions.sidebar.attachToWorktree.success': '세션을 워크트리에 연결했습니다',
  'sessions.sidebar.attachToWorktree.error': '워크트리 연결에 실패했습니다',
  'sessions.sidebar.attachToWorktree.detachSuccess': '워크트리 연결을 해제했습니다',
  'sessions.sidebar.attachToWorktree.detachError': '워크트리 연결 해제에 실패했습니다',
