...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.attachToWorktree': 'Dołącz do worktree',
  'sessions.sidebar.session.menu.detachFromWorktree': 'Odłącz od worktree',
  ...
  'sessions.sidebar.attachToWorktree.title': 'Dołącz do worktree',
  'sessions.sidebar.attachToWorktree.description': 'Wybierz worktree, aby wyświetlić jego zmiany git i gałąź w tej sesji.',
  'sessions.sidebar.attachToWorktree.confirm': 'Dołącz',
  'sessions.sidebar.attachToWorktree.detach': 'Odłącz',
  'sessions.sidebar.attachToWorktree.noWorktrees': 'Brak dostępnych worktree dla tego projektu.',
  'sessions.sidebar.attachToWorktree.success': 'Sesja dołączona do worktree',
  'sessions.sidebar.attachToWorktree.error': 'Nie udało się dołączyć sesji do worktree',
  'sessions.sidebar.attachToWorktree.detachSuccess': 'Sesja odłączona od worktree',
  'sessions.sidebar.attachToWorktree.detachError': 'Nie udało się odłączyć sesji od worktree',
