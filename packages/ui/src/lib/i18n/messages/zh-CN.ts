...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.attachToWorktree': '设置虚拟工作树',
  ...
  'sessions.sidebar.attachToWorktree.title': '设置虚拟工作树',
  'sessions.sidebar.attachToWorktree.description': '选择一个工作树，在此会话中查看其 git 变更和分支。',
  'sessions.sidebar.attachToWorktree.confirm': '设置',
  'sessions.sidebar.attachToWorktree.detach': '移除',
  'sessions.sidebar.attachToWorktree.noWorktrees': '此项目没有可用的工作树。',
  'sessions.sidebar.attachToWorktree.success': '已设置虚拟工作树',
  'sessions.sidebar.attachToWorktree.error': '无法设置虚拟工作树',
  'sessions.sidebar.attachToWorktree.detachSuccess': '已移除虚拟工作树',
  'sessions.sidebar.attachToWorktree.detachError': '无法移除虚拟工作树',
