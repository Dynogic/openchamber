...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.attachToWorktree': '关联到工作树',
  'sessions.sidebar.session.menu.detachFromWorktree': '取消关联工作树',
  ...
  'sessions.sidebar.attachToWorktree.title': '关联到工作树',
  'sessions.sidebar.attachToWorktree.description': '选择一个工作树，在此会话中查看其 git 变更和分支。',
  'sessions.sidebar.attachToWorktree.confirm': '关联',
  'sessions.sidebar.attachToWorktree.detach': '取消关联',
  'sessions.sidebar.attachToWorktree.noWorktrees': '此项目没有可用的工作树。',
  'sessions.sidebar.attachToWorktree.success': '会话已关联到工作树',
  'sessions.sidebar.attachToWorktree.error': '无法将会话关联到工作树',
  'sessions.sidebar.attachToWorktree.detachSuccess': '会话已取消关联工作树',
  'sessions.sidebar.attachToWorktree.detachError': '无法取消关联工作树',
