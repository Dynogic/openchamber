...
export const dict = {
  ...
  'sessions.sidebar.session.menu.attachToWorktree': 'Attach to worktree',
  'sessions.sidebar.session.menu.detachFromWorktree': 'Detach from worktree',
  ...
  'sessions.sidebar.attachToWorktree.title': 'Attach to worktree',
  'sessions.sidebar.attachToWorktree.description': 'Select a worktree to view its git changes and branch in this session.',
  'sessions.sidebar.attachToWorktree.confirm': 'Attach',
  'sessions.sidebar.attachToWorktree.detach': 'Detach',
  'sessions.sidebar.attachToWorktree.noWorktrees': 'No worktrees available for this project.',
  'sessions.sidebar.attachToWorktree.success': 'Session attached to worktree',
  'sessions.sidebar.attachToWorktree.error': 'Failed to attach session to worktree',
  'sessions.sidebar.attachToWorktree.detachSuccess': 'Session detached from worktree',
  'sessions.sidebar.attachToWorktree.detachError': 'Failed to detach session from worktree',
