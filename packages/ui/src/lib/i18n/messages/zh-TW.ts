...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.attachToWorktree.title': '關聯到工作樹',
  'sessions.sidebar.attachToWorktree.description': '選擇一個工作樹，在此對話中查看其 git 變更和分支。',
  'sessions.sidebar.attachToWorktree.confirm': '關聯',
  'sessions.sidebar.attachToWorktree.detach': '取消關聯',
  'sessions.sidebar.attachToWorktree.noWorktrees': '此專案沒有可用的工作樹。',
  'sessions.sidebar.attachToWorktree.success': '對話已關聯到工作樹',
  'sessions.sidebar.attachToWorktree.error': '無法將對話關聯到工作樹',
  'sessions.sidebar.attachToWorktree.detachSuccess': '對話已取消關聯工作樹',
  'sessions.sidebar.attachToWorktree.detachError': '無法取消關聯工作樹',
