...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.attachToWorktree': '設定虛擬工作樹',
  ...
  'sessions.sidebar.attachToWorktree.title': '設定虛擬工作樹',
  'sessions.sidebar.attachToWorktree.description': '選擇一個工作樹，在此對話中查看其 git 變更和分支。',
  'sessions.sidebar.attachToWorktree.confirm': '設定',
  'sessions.sidebar.attachToWorktree.detach': '移除',
  'sessions.sidebar.attachToWorktree.noWorktrees': '此專案沒有可用的工作樹。',
  'sessions.sidebar.attachToWorktree.success': '已設定虛擬工作樹',
  'sessions.sidebar.attachToWorktree.error': '無法設定虛擬工作樹',
  'sessions.sidebar.attachToWorktree.detachSuccess': '已移除虛擬工作樹',
  'sessions.sidebar.attachToWorktree.detachError': '無法移除虛擬工作樹',
